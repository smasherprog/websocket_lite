...
namespace WS_LITE {
    ...
    std::error_code TLSContext::clear_options(options o, std::error_code &ec) { return impl->sslcontext.clear_options(o, ec); }
    void TLSContext::set_options(unsigned long o) { impl->sslcontext.set_options(o); }
    std::error_code TLSContext::set_options(options o, std::error_code &ec) { return impl->sslcontext.set_options(o, ec); }
    void TLSContext::set_verify_mode(verify_mode v) { impl->sslcontext.set_verify_mode(v); }
    std::error_code TLSContext::set_verify_mode(verify_mode v, std::error_code &ec) { return impl->sslcontext.set_verify_mode(v, ec); }
    void TLSContext::set_verify_depth(int depth) { impl->sslcontext.set_verify_depth(depth); }
    std::error_code TLSContext::set_verify_depth(int depth, std::error_code &ec) { return impl->sslcontext.set_verify_depth(depth, ec); }
    ...
    {
        return impl->sslcontext.set_verify_callback([callback](bool p, asio::ssl::verify_context &ctx) { return callback(p, ctx.native_handle()); },
                                                    ec);
    }
    ...
    {
        return impl->sslcontext.load_verify_file(filename, ec);
    }
    ...
    {
        return impl->sslcontext.add_certificate_authority(asio::const_buffer(buffer, buffer_size), ec);
    }
    ...
    std::error_code TLSContext::set_default_verify_paths(std::error_code &ec) { return impl->sslcontext.set_default_verify_paths(ec); }

    void TLSContext::add_verify_path(const std::string &path) { impl->sslcontext.add_verify_path(path); }

    std::error_code TLSContext::add_verify_path(const std::string &path, std::error_code &ec) { return impl->sslcontext.add_verify_path(path, ec); }
    ...
    {
        return impl->sslcontext.use_certificate(asio::const_buffer(buffer, buffer_size), static_cast<asio::ssl::context_base::file_format>(format),
                                                ec);
    }
    ...
    {
        return impl->sslcontext.use_certificate_file(filename, static_cast<asio::ssl::context_base::file_format>(format), ec);
    }
    ...
    {
        return impl->sslcontext.use_certificate_chain(asio::const_buffer(buffer, buffer_size), ec);
    }
    ...
    {
        return impl->sslcontext.use_certificate_chain_file(filename, ec);
    }
    ...
    {
        return impl->sslcontext.use_private_key(asio::const_buffer(buffer, buffer_size), static_cast<asio::ssl::context_base::file_format>(format),
                                                ec);
    }
    ...
    {
        return impl->sslcontext.use_private_key_file(filename, static_cast<asio::ssl::context_base::file_format>(format), ec);
    }
    ...
    {
        return impl->sslcontext.use_rsa_private_key(asio::const_buffer(buffer, buffer_size),
    ...
    {
        return impl->sslcontext.use_rsa_private_key_file(filename, static_cast<asio::ssl::context_base::file_format>(format), ec);
    }
    ...
    {
        return impl->sslcontext.use_tmp_dh(asio::const_buffer(buffer, buffer_size), ec);
    }

    void TLSContext::use_tmp_dh_file(const std::string &filename) { impl->sslcontext.use_tmp_dh_file(filename); }

    std::error_code TLSContext::use_tmp_dh_file(const std::string &filename, std::error_code &ec)
    {
        return impl->sslcontext.use_tmp_dh_file(filename, ec);
    }
    ...
    std::error_code TLSContext::set_password_callback(std::function<std::string(std::size_t, password_purpose)> &callback, asio::error_code &ec)
    {
        ...
        return impl->sslcontext.set_password_callback(
